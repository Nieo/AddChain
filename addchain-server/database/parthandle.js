...
exports.getRelatedPostProcesses = (id) => {return db.any('SELECT refinements.post_process_id, post_processes.name, post_processes.description, post_processes.comment  ' +
    'FROM refinements INNER JOIN post_processes ON refinements.post_process_id = post_processes.post_process_id WHERE refinements.part_id=$1',[id])};
